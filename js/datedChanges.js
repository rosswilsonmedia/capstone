...
//Home Page Changes
var watchHomeButton=document.querySelector('.button[href="watch.html"]');
if(watchHomeButton){
...
var watchTabs=document.querySelectorAll('[role="navigation"] a[href="watch.html"]');
if(d>=dayOf&&d<showTime){
    if(pageName=="home.html"){
        watchHomeButton=document.querySelector('.button[href="watch.html"]');
    }
